...
export const convertPascalCaseToSnakeCase = () => {
  return pascalCaseVariableName.replace(/([A-Z])/g, "_$1").slice(1).toLowerCase();
  //replace all capital letters with an _in front (definitely Googled this!), changed the entire string to lower case and used splice to remove the first _
  //https://stackoverflow.com/questions/30521224/javascript-convert-pascalcase-to-underscore-case/30521308
};
